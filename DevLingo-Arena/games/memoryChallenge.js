...
function memoryChallenge() {
    ...
    ["server", "client", "data", "logic", "syntax"],
    ["compiler", "algorithm", "interface", "repository", "structure"],
    ["parameter", "integer", "boolean", "constant", "iteration"],
    ["password", "encryption", "firewall", "protocol", "authentication"]];
